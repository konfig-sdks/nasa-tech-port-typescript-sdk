...
/**
 * This class provides a wrapper for network errors when making requests to TechPort
 */
export class NasaTechPortError extends Error {
  /**
   * The response body
   */
